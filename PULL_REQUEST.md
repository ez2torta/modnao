...
- **Solution**: 
  - Created [`getMipmapOffset.ts`](file:///home/tortita/Coding/Github/Side/mvc2_custom/Tools/modnao/src/utils/textures/getMipmapOffset.ts) implementing the exact geometric formula:
  ...
  - Added unit tests in [`getMipmapOffset.spec.ts`](file:///home/tortita/Coding/Github/Side/mvc2_custom/Tools/modnao/src/utils/textures/getMipmapOffset.spec.ts).
...
- **`DM08CAB.BIN` (Cable & Ruby Heart Intro Art)**:
  ...
  - Added test suite in [`dm08CabRoundtrip.spec.ts`](file:///home/tortita/Coding/Github/Side/mvc2_custom/Tools/modnao/src/utils/textures/dm08CabRoundtrip.spec.ts).
...
- Added [`src/cli/mvc2TextureManager.ts`](file:///home/tortita/Coding/Github/Side/mvc2_custom/Tools/modnao/src/cli/mvc2TextureManager.ts) and [`src/cli/index.ts`](file:///home/tortita/Coding/Github/Side/mvc2_custom/Tools/modnao/src/cli/index.ts) allowing users to dump and inject all supported MvC2 textures via Node.js scripts (`npm run textures:dump` and `npm run textures:inject`) using `jimp` instead of headless browser canvas.
